                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full" src="{{ $stadium->clubs->logo }}"
                                                    alt="" />
                                            </div>
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">{{ number_format($stadium->capacity) }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $stadium->clubs->name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        {{ $stadium->address }}
                                    </td>
